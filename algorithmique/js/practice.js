...
let message = `Bonjour, je suis une variable qui contient un message de bienvenue`;
console.log(message);
...
let message2 = `Je découvre le javascript`;
console.log(message2 + ` et je suis très heureux de tout ce que j'apprend`);
...
function MESSAGEBONJOUR(prenom) {
  console.log(
    `Bonjour ${prenom}, je suis une fonction qui affiche un message de bienvenue dans la console et qui prend un parametre`
  );
}

MESSAGEBONJOUR(prenom);
...
function messageBonjouravecDeuxparametres(prenom, age) {
  let message = `Bonjour ${prenom}, vous avez ${age} ans, je suis une fonction qui affiche un message de bienvenue dans la console et qui prend deux parametres`;
  return message;
}

let age2 = messageBonjouravecDeuxparametres(`Hugo`, 28);
...
function animaux(animalPrefere) {
  if (animalPrefere == chat || animalPrefere == chien) {
    console.log(`Vous aimez les animaux domestiques !`);
  } else if (animalPrefere == lion || animalPrefere == tigre) {
    console.log(`Vous aimez les animaux sauvages !`);
...
for (let tour = 1; tour < nombre; tour++) {
  console.log(tour);
}
...
let nombre2 = prompt(`Veuillez indiquer un nombre`);

for (let tour = 1; tour < 11; tour++) {
  let multiplication = nombre2 * tour;
  console.log(`${nombre2} x ${tour}= ${multiplication}`);
}
